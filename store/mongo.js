...
module.exports = function(storeConfig) {
  ...
  var _openDb = function(database, callback) {
    return mongo.MongoClient.connect('mongodb://' + storeConfig.host + '/' + database, callback);
  };
  ...
  var insert = function(obj, context, callback) {
    ...
    _openDb(context.database, function(error, db) {
